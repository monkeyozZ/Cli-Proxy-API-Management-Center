...
import type { ClaudeQuotaState, CodexQuotaState, KimiQuotaState, KiroQuotaState } from '@/types';
...
describe('KiroQuotaBody', () => {
  test('renders plan, remaining balance, usage, and the Unix-seconds reset', () => {
    const resetAtMs = now + 3 * HOUR_MS;
